...
SECRET_KEY = 'django-insecure-xjxabljpi)n%w48h=%at^-3n4^n!jo$23c%w4c@x6#)@4snfpv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'layouts/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'chaves.wsgi.application'
